...
public class CodeGenUtils {
	...
	public static void genLog(boolean GEN, MethodVisitor mv, String message) {
		if (GEN) {
			mv.visitLdcInsn(message + ";");
			mv.visitMethodInsn(Opcodes.INVOKESTATIC, "cop5556sp18/RuntimeLog", "globalLogAddEntry",
	...
	public static void genLogTOS(boolean GEN, MethodVisitor mv, Type type) {
		if (GEN) {
			...
			case IMAGE: {
				...
				mv.visitMethodInsn(Opcodes.INVOKESTATIC, "cop5556sp18/RuntimeLog", "globalLogAddImage",
						"(" + RuntimeImageSupport.ImageDesc + ")V", false);
				return;
			}
			default: {
