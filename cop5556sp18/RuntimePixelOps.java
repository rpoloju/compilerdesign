...
public class RuntimePixelOps {
	...
	public static final int SELECT_RED = 0x00ff0000, SELECT_GRN = 0x0000ff00, SELECT_BLU = 0x000000ff,
			SELECT_ALPHA = 0xff000000;

	// bits to shift to convert to and from int
	public static final int SHIFT_ALPHA = 24, SHIFT_RED = 16, SHIFT_GRN = 8, SHIFT_BLU = 0;

	// values for zeroing individual colors in packed pixels
	public static final int ZERO_RED = 0xff00ffff, ZERO_GRN = 0xffff00ff, ZERO_BLU = 0xffffff00,
	...
	/*
	 * extract a sample from a pixel, color code should be RED,GRN, or BLU from
	...
	/*
	 * create a pixel with the given color values. Values less than 0 or greater
	...
	/*
	 * String showing pixel in Hex format, alpha, red, grn, and blu components are
	 * each two digits.
	 */
